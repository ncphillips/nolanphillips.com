...
export const Panel: React.FC<PanelProps> = ({
  ...
  let classes = [
    "flex-col gap-2 basis-full lg:basis-96 shrink-0 min-h-screen sticky top-0 md:gap-4 border-r border-1 border-zinc-200 dark:border-zinc-800 py-4 px-6 lg:pt-0 lg:overflow-y-auto lg:overflow-x-hidden",
  ];
